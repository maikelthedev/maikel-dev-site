...
-file("src/earmark_string_lexer.erl", 307).
yystate() -> 2.
...
-file("src/earmark_string_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { other, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/earmark_string_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { escape, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/earmark_string_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
