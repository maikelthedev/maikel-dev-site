var translations = {
  en: {
    ...
    contactDesc: 'Ready to start your project? Reach out via email and I\'ll get back to you within 24 hours.',
  ...
  es: {
    ...
    contactDesc: '¿Listo para iniciar tu proyecto? Ponte en contacto por correo electrónico y te responderé en menos de 24 horas.',
...
var i18n = {
  currentLang: 'en',
  STORAGE_KEY: 'maikel-dev-lang',
  
  init: function() {
    var saved = null;
    try { saved = localStorage.getItem(this.STORAGE_KEY); } catch (e) {}
    this.currentLang = (saved === 'es' || saved === 'en') ? saved : 'en';
    this.apply();
  ...
  apply: function() {
    ...
    document.querySelectorAll('.lang-toggle [data-lang]').forEach(function(btn) {
      btn.setAttribute('aria-pressed', btn.getAttribute('data-lang') === i18n.currentLang ? 'true' : 'false');
    });
  },
