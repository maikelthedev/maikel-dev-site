        ...
        <div className="custom-text-black flex flex-col md:flex-row p-5 custom-bg-white md:mx-auto md:max-w-6xl items-center">
          <div className="px-8 py-4 space-y-6">
            ...
            <p className="text-lg">
              ...
              rationing my meals, to getting food. You get me from a constant never ending level of paralysis panic, to a better place where my attention isn't kidnapped by basic survival adrenalinergic worries. You get me from thinking how to commit suicide, to wonder whether I should change my gym workout table from cutting to a bulking cycle. 
            </p>
            <p className="text-lg">Take every word I say here very literally because that's the reason I de-chatGPTfied this page, I want you to TRULY KNOW how bad things are right now</p>
            <p className="text-lg line-through">
            ...
            <p className="text-lg">
              ...
              food on the table so that I can keep trying different ways to do that myself, is that simple.
              I've got a killer IT skillset but for some reason that escapes my understanding I am still jobless. 
            </p>
            ...
            <ul className="list-disc px-8 space-y-2">
              <li className="list-item">
                ...
                Food on table. It doesn't cover rent. The fact it doesn't cover rent is why I'm in Triana and not in Amate (both in Seville) taking space on the flat of a friend who is on holidays. And the main reason for my sleepless nights as he comes back on the 3rd of September and I have no idea what to do but I'll have to leave before yet I have no idea where. 
              </li>
              <li className="list-item">
                <span className="line-through">
              ...
              <span className="line-through">
                ...
                necessary for my business's legal structure.</span>
                35€ of Xolo.io, 40€ of the gym, 25 GBP of my Virgin credit card very minimum payment, 30GBP of my monzo Flex loan, both maxed out because I eat. 6€ of my Spanish phone number around 10 GBP every 3 months to maintain my British number (dual sim phone). That's literally it. 
              </li>
            </ul>
            ...
            <p className="text-lg">
              ...
              account to support my immediate needs during this <span className="line-through">transitional
              phase.</span> messed up time. It won't solve anything on the long-term, nor medium term, I'm fully transparent on what comes through on my toots on the fedi. I don't have the right to any benefits, here or in the UK nor access to any social services. I would fly blindly wherever I had a job if I had it secured. If it was up to me I'd be back in London, get a McJob and move on with life. But as you know I tried that in December 2022/January 2023, and all I did was to run out of time to find accommodation. 
            </p>
          </div>
        </div>
      </div>
