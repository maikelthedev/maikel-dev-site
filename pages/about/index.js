        ...
        <div className=" custom-text-black flex flex-col md:flex-row p-5 custom-bg-white md:mx-auto md:max-w-6xl">
          <div className="w-full  md:p-10 p-5 space-y-5">
            ...
            <p className="text-md">
              ...
              childhood calls me Maikel. It is Michael written with the Spanish
              spelling. Changing your legal name to your real name is a
              bureaucratic nightmare in Spain, so I decided to keep my legal
              name and use my real name for my company.
            </p>
            <p className="text-md">
              The known fact Spain is a bureaucratic nightmare is the main
              reason I established the company in Estonia. The admin is far
              simpler, which translates into more time to focus on my clients,
              and less time dealing with paperwork.
            </p>
            <p className="text-md">
              I am a multi-lingual full-stack developer, cloud architect and
              DevOps engineer. Also a native Spanish speaker, fluent in English.
